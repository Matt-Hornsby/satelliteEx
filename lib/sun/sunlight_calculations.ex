defmodule Sun.SunlightCalculations do
  ...
  defp get_base_magnitude(standard_magnitude, satellite_position, sun_position, observer_position, gmst) do
    ...
    observer_geoc_x = :math.cos(observer_geocentric.geo_lat) * :math.cos(observer_position.longitude_rad)
    observer_geoc_y = :math.cos(observer_geocentric.geo_lat) * :math.sin(observer_position.longitude_rad)
  ...
  defp adjust_magnitude_for_sunset(base_magnitude, sun_elevation) when sun_elevation > -10 and sun_elevation < 0 do
