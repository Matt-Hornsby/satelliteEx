defmodule Sun.SunPosition do
  ...
  def get_position_at({{_year, _month, _day}, {_hour, _min, _sec}} = input_date,
                        observer_latitude, observer_longitude) do
    ...
    observer_geo_x = :math.cos(observer_latitude)
                          * :math.cos(observer_longitude)
    observer_geo_y = :math.cos(observer_latitude)
...
@doc """
  ...
  def calculate_orbital_coordinates_at(julian_date) do
    ...
    d0 = julian_date - 2_451_545 # 2,451,545 is the julian date on 1/1/2000
    ...
    declination = :math.asin(:math.sin(e / 180 * Constants.pi)
