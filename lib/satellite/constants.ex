defmodule Satellite.Constants do
  ...
  defmacro earth_radius, do: 6378.137  # in km
  defmacro mu, do: 398600.5           # in km3 / s2
  defmacro xke, do: 60.0 / :math.sqrt(earth_radius() * earth_radius() * earth_radius() / mu())
  defmacro tumin, do: 1.0 / xke()
  defmacro degtorad, do: pi() / 180.0
